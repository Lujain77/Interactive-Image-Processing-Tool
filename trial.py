...
class ImageProcessingApp:
    ...
    def remove_periodic_noise(self):
        if self.perodic_noise is not None:
            ...
            mask_button = tk.Button(remove_periodic_noise_window, text="Mask", command=self.mask, bg="#101314",
                                    fg="white", width=20, height=2, font=("Helvetica", 12, "bold"))
            ban_button = tk.Button(remove_periodic_noise_window, text="Band_reject", command=self.band_reject,
                                   bg="#101314", fg="white", width=20, height=2, font=("Helvetica", 12, "bold"))
